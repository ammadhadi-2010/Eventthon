...
payment_gateway_events_collection = database.get_collection("payment_gateway_events")
payment_checkout_sessions_collection = database.get_collection("payment_checkout_sessions")
...
company_members_collection = database.get_collection("company_members")
company_invites_collection = database.get_collection("company_invites")
company_audit_logs_collection = database.get_collection("company_audit_logs")
job_alerts_collection = database.get_collection("job_alerts")
job_alert_matches_collection = database.get_collection("job_alert_matches")
...
company_hiring_threads_collection = database.get_collection("company_hiring_threads")
company_recruiter_notes_collection = database.get_collection("company_recruiter_notes")
...
outreach_activity_collection = database.get_collection("outreach_activity")
outreach_scheduled_collection = database.get_collection("outreach_scheduled_emails")
outreach_templates_collection = database.get_collection("outreach_templates")
outreach_replies_collection = database.get_collection("outreach_replies")
outreach_ai_responder_settings_collection = database.get_collection("outreach_ai_responder_settings")
...
donation_config_collection = database.get_collection("donation_config")
donation_intents_collection = database.get_collection("donation_intents")
newsletter_subscribers_collection = database.get_collection("newsletter_subscribers")