...
from .routes_company_hiring import router as company_hiring_router
from .routes_squad_inbox import router as squad_inbox_router
...
router.include_router(company_hiring_router)
router.include_router(squad_inbox_router)
