...
from .list_routes import fetch_all_squads, fetch_squads_hub, router as list_router
...
from .hire_routes import router as hire_router
...
router.include_router(hire_router)

__all__ = ["router", "fetch_all_squads", "fetch_squads_hub", "create_squad_impl"]
