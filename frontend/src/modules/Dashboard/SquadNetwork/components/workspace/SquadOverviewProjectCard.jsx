...
export default function SquadOverviewProjectCard({ project }) {
  ...
  return (
    <article className="sq-ws-mini-project sq-ws-mini-project--with-media">
      <div
        className="sq-ws-mini-project__cover"
        style={{ backgroundImage: `url(${model.coverImage})` }}
        role="img"
        aria-label={`${model.title} cover`}
      />
      <div className="sq-ws-mini-project__body">
