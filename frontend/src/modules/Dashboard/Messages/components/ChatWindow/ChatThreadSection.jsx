...
const ChatThreadSection = ({
  ...
  const threadLen = Array.isArray(thread) ? thread.length : 0;
  const lastId = threadLen ? thread[threadLen - 1]?.id : '';
  ...
  }, [peerKey, lastId, threadLen]);

  return (
    <div ref={threadRef} className="msgx-chat-thread">
